...
const Footer: React.FC = () => {
  return (
    <footer id="contato" className="bg-surfaceHighlight pt-20 pb-10 border-t border-primary/10 transition-colors duration-500">
      <div className="container mx-auto px-6 flex flex-col items-center">
        ...
        <div className="flex space-x-8 mb-12">
          <a href="https://www.instagram.com/ateliee_saboress/" target="_blank" rel="noopener noreferrer" className="p-3 bg-surface rounded-full text-primary shadow-sm hover:text-white hover:bg-primary hover:shadow-md transition-all duration-300" aria-label="Instagram">
            <Instagram size={24} />
          </a>
          <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="p-3 bg-surface rounded-full text-primary shadow-sm hover:text-white hover:bg-primary hover:shadow-md transition-all duration-300" aria-label="WhatsApp">
